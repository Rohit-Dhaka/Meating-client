...
const Home = () => {
    ...
    const [currentUserId, setCurrentUserId] = useState(null); // Assuming you store the logged-in user's ID

    useEffect(() => {
        // Fetch current user ID from localStorage or authentication context
